...
public class AlmacenController implements Initializable {
    ...
    @FXML
    private Button botonActualizarTabla;

    @FXML
    private Button botonAgregarProducto;

    @FXML
    private Button botonEliminarTransaccion;

    @FXML
    private Button botonFinalizarT;

    @FXML
    private Button bottonBuscarClienteT;

    @FXML
    private TextField cantidadProductoT;

    @FXML
    private TableColumn<?, ?> cantidadTabla;

    @FXML
    private TextField codeProductoT;

    @FXML
    private TableColumn<?, ?> codeProductoTabla;

    @FXML
    private TextField codigoEliminar;

    @FXML
    private TableColumn<?, ?> columnaCodeT;

    @FXML
    private TableColumn<?, ?> columnaFechaT;

    @FXML
    private DatePicker fechaT;

    @FXML
    private TableColumn<?, ?> columnaTotalT;

    @FXML
    private TableColumn<?, ?> columnaUsuarioT;

    @FXML
    private TextField idClienteT;

    @FXML
    private TextField nombreClienteT;

    @FXML
    private TableColumn<Double, Double> subTotal;

    @FXML
    private TableView<?> tablaFact;

    @FXML
    private TableView<?> tablaTransacciones;

    @FXML
    private TextField totalT;

    @FXML
    private TableColumn<?, ?> valorUnitarioTabla;
    ...
    void agregarProducto(ActionEvent event) {
        String nombre = codeProductoT.getText();
        Integer cantidad = Integer.parseInt(cantidadProductoT.getText());
    ...
    void buscarCliente(ActionEvent event) {
        String id = idClienteT.getText();
        if(mfm.clienteExiste(id)){
            nombreClienteT.setText(mfm.buscarCliente(id).getNombres());
        }
        else{
    ...
    void eliminarTransaccion(ActionEvent event) {
        String code = codigoEliminar.getText();
        mfm.eliminarTransaccion(code);
    }

    @FXML
    void finalizarTransaccion(ActionEvent event) {
        String nombre= nombreClienteT.getText();
        String id= idClienteT.getText();
        String fecha= fechaT.getValue().toString();
        double total= Double.parseDouble(totalT.getText());
        int cant= (Integer.parseInt(cantidadProductoT.getText()));
        Producto producto= mfm.buscarProductoNombre(nombre);
        double subTotal= producto.getValorUnitario()*cant;

        //DetalleTransaccion detalle= new DetalleTransaccion(cant,subTotal,)
        //mfm.crearTransaccion(fecha,GeneradorCodigo.generarCodigoUnico(),total,, productos);
    }
